...
export function registerDSL() {
    ...
    monaco.languages.register({
        id: 'projection',
        aliases: ['PROJECTION', 'projection'],
        extensions: ['.projection'],
        mimetypes: ['text/projection']
    })
    monaco.languages.setLanguageConfiguration('projection', {
        comments: {
            lineComment: "//",
            blockComment: ['/*', '*/']
        },
    ...
    monaco.languages.setMonarchTokensProvider('projection', <any>{
