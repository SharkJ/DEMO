...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>enum lookup list flag setting</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link io.typefox.xtext.langserver.example.myDsl.impl.enum_lookup_list_flag_settingImpl#getProjection_flag_condition <em>Projection flag condition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class enum_lookup_list_flag_settingImpl extends MinimalEObjectImpl.Container implements enum_lookup_list_flag_setting
{
  /**
   ...
   * @generated
   */
  protected enum_lookup_list_flag_settingImpl()
  {
    super();
  }
  ...
  {
    return MyDslPackage.Literals.ENUM_LOOKUP_LIST_FLAG_SETTING;
  }
  ...
  public NotificationChain basicSetProjection_flag_condition(projection_flag_condition newProjection_flag_condition, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.ENUM_LOOKUP_LIST_FLAG_SETTING__PROJECTION_FLAG_CONDITION, oldProjection_flag_condition, newProjection_flag_condition);
  ...
  public void setProjection_flag_condition(projection_flag_condition newProjection_flag_condition)
  {
    if (newProjection_flag_condition != projection_flag_condition)
    {
      ...
      if (projection_flag_condition != null)
        msgs = ((InternalEObject)projection_flag_condition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.ENUM_LOOKUP_LIST_FLAG_SETTING__PROJECTION_FLAG_CONDITION, null, msgs);
      if (newProjection_flag_condition != null)
        msgs = ((InternalEObject)newProjection_flag_condition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.ENUM_LOOKUP_LIST_FLAG_SETTING__PROJECTION_FLAG_CONDITION, null, msgs);
      msgs = basicSetProjection_flag_condition(newProjection_flag_condition, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.ENUM_LOOKUP_LIST_FLAG_SETTING__PROJECTION_FLAG_CONDITION, newProjection_flag_condition, newProjection_flag_condition));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.ENUM_LOOKUP_LIST_FLAG_SETTING__PROJECTION_FLAG_CONDITION:
...
} //enum_lookup_list_flag_settingImpl
