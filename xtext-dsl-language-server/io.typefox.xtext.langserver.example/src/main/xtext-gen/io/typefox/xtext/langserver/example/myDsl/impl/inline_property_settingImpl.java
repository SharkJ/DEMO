...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>inline property setting</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link io.typefox.xtext.langserver.example.myDsl.impl.inline_property_settingImpl#getProjection_flag_condition <em>Projection flag condition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class inline_property_settingImpl extends MinimalEObjectImpl.Container implements inline_property_setting
{
  /**
   ...
   * @generated
   */
  protected inline_property_settingImpl()
  {
    super();
  }
  ...
  {
    return MyDslPackage.Literals.INLINE_PROPERTY_SETTING;
  }
  ...
  public NotificationChain basicSetProjection_flag_condition(projection_flag_condition newProjection_flag_condition, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.INLINE_PROPERTY_SETTING__PROJECTION_FLAG_CONDITION, oldProjection_flag_condition, newProjection_flag_condition);
  ...
  public void setProjection_flag_condition(projection_flag_condition newProjection_flag_condition)
  {
    if (newProjection_flag_condition != projection_flag_condition)
    {
      ...
      if (projection_flag_condition != null)
        msgs = ((InternalEObject)projection_flag_condition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.INLINE_PROPERTY_SETTING__PROJECTION_FLAG_CONDITION, null, msgs);
      if (newProjection_flag_condition != null)
        msgs = ((InternalEObject)newProjection_flag_condition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.INLINE_PROPERTY_SETTING__PROJECTION_FLAG_CONDITION, null, msgs);
      msgs = basicSetProjection_flag_condition(newProjection_flag_condition, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.INLINE_PROPERTY_SETTING__PROJECTION_FLAG_CONDITION, newProjection_flag_condition, newProjection_flag_condition));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.INLINE_PROPERTY_SETTING__PROJECTION_FLAG_CONDITION:
