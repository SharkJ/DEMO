...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>tag union definition</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link io.typefox.xtext.langserver.example.myDsl.impl.tag_union_definitionImpl#getDataitem_reference <em>Dataitem reference</em>}</li>
 * </ul>
 *
 * @generated
 */
public class tag_union_definitionImpl extends MinimalEObjectImpl.Container implements tag_union_definition
{
  /**
   ...
   * @generated
   */
  protected tag_union_definitionImpl()
  {
    super();
  }
  ...
  {
    return MyDslPackage.Literals.TAG_UNION_DEFINITION;
  }
  ...
  public NotificationChain basicSetDataitem_reference(dataitem_reference newDataitem_reference, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.TAG_UNION_DEFINITION__DATAITEM_REFERENCE, oldDataitem_reference, newDataitem_reference);
  ...
  public void setDataitem_reference(dataitem_reference newDataitem_reference)
  {
    if (newDataitem_reference != dataitem_reference)
    {
      ...
      if (dataitem_reference != null)
        msgs = ((InternalEObject)dataitem_reference).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.TAG_UNION_DEFINITION__DATAITEM_REFERENCE, null, msgs);
      if (newDataitem_reference != null)
        msgs = ((InternalEObject)newDataitem_reference).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.TAG_UNION_DEFINITION__DATAITEM_REFERENCE, null, msgs);
      msgs = basicSetDataitem_reference(newDataitem_reference, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.TAG_UNION_DEFINITION__DATAITEM_REFERENCE, newDataitem_reference, newDataitem_reference));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.TAG_UNION_DEFINITION__DATAITEM_REFERENCE:
