...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>stream attachment attribute</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link io.typefox.xtext.langserver.example.myDsl.impl.stream_attachment_attributeImpl#getProjection_flag_condition <em>Projection flag condition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class stream_attachment_attributeImpl extends MinimalEObjectImpl.Container implements stream_attachment_attribute
{
  /**
   ...
   * @generated
   */
  protected stream_attachment_attributeImpl()
  {
    super();
  }
  ...
  {
    return MyDslPackage.Literals.STREAM_ATTACHMENT_ATTRIBUTE;
  }
  ...
  public NotificationChain basicSetProjection_flag_condition(projection_flag_condition newProjection_flag_condition, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.STREAM_ATTACHMENT_ATTRIBUTE__PROJECTION_FLAG_CONDITION, oldProjection_flag_condition, newProjection_flag_condition);
  ...
  public void setProjection_flag_condition(projection_flag_condition newProjection_flag_condition)
  {
    if (newProjection_flag_condition != projection_flag_condition)
    {
      ...
      if (projection_flag_condition != null)
        msgs = ((InternalEObject)projection_flag_condition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.STREAM_ATTACHMENT_ATTRIBUTE__PROJECTION_FLAG_CONDITION, null, msgs);
      if (newProjection_flag_condition != null)
        msgs = ((InternalEObject)newProjection_flag_condition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.STREAM_ATTACHMENT_ATTRIBUTE__PROJECTION_FLAG_CONDITION, null, msgs);
      msgs = basicSetProjection_flag_condition(newProjection_flag_condition, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.STREAM_ATTACHMENT_ATTRIBUTE__PROJECTION_FLAG_CONDITION, newProjection_flag_condition, newProjection_flag_condition));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.STREAM_ATTACHMENT_ATTRIBUTE__PROJECTION_FLAG_CONDITION:
...
} //stream_attachment_attributeImpl
